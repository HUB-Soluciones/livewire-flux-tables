...
<div x-data="{ open: false }" class="relative inline-flex items-center">
    <input
        ...
        class="h-4 w-4 cursor-pointer rounded border-zinc-300 text-blue-600 transition focus:ring-2 focus:ring-blue-500 focus:ring-offset-0"
    />
    ...
    <div
        ...
        class="absolute left-0 top-full z-50 mt-1 min-w-[14rem] rounded-lg border border-zinc-200 bg-white py-1 shadow-lg"
        style="display: none;"
    >
        <button
            type="button"
            ...
            @click="open = false"
            class="block w-full px-4 py-2 text-left text-sm text-zinc-700 hover:bg-zinc-50"
        >
